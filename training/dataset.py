    ...
    def __init__(
        ...
        **super_kwargs,  # Additional arguments for the Dataset base class.
        ...
        if resolution is not None:
            assert raw_shape[2] == raw_shape[3]
            assert raw_shape[2] % resolution == 0, "Resolution must be divisible by the image resolution"
            if raw_shape[2] != resolution:
                self.downsample = raw_shape[2] // resolution
                raw_shape[2] = raw_shape[3] = resolution
                dist.print0(f"Downsampling images by a factor of {self.downsample}")
