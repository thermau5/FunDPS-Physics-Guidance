...
parser = argparse.ArgumentParser(
    description="Test an FNO or SongUNO surrogate (forward or inverse).")
parser.add_argument(
    "--model-path", "-m", required=True,
    help=".pth file of trained FNO or SongUNO model (forward or inverse).")
parser.add_argument(
...
parser.add_argument(
    "--output-dir", "-o", default="prediction_visualizations",
    help="Directory to save prediction visualization examples.")
parser.add_argument(
    "--save-examples", "-s", type=int, default=5,
...
if "uno_trained" in model_path:
    ...
    model = FNO_pad(n_modes=(64,64), in_channels=1, out_channels=1,
